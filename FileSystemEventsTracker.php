...
class FileSystemEventsTracker
{
     ...
     * 
     * @param string $pPath
     *            sciezka do monitorowanego katalogu
    ...
    /**
     * Obsluga zdarzenia, np.
     * wyswietlenie komunikatu $pMsg na STDOUT
     * 
     * @param string $pMsg
     *            logowany komunikat (opcjonalny)
     ...
     * @retrun boolean czy obsluzono zdarzenia prawidlowo
     */
    public function run()
    {
